...
public class MvcControllerIntegTestHelpers {
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int balance, int totalDeposit, int overdraftBalance, int numFraudReversals) throws ScriptException {
    String insertCustomerSql = String.format("INSERT INTO Customers VALUES ('%s', '%s', '%s', %d, %d, %d, %d)", ID, firstName, lastName, balance, totalDeposit, overdraftBalance, numFraudReversals);
  ...
  public static void addCustomerToDB(DatabaseDelegate dbDelegate, String ID, String password, String firstName, String lastName, int balance, int totalDeposit) throws ScriptException {
    addCustomerToDB(dbDelegate, ID, password, firstName, lastName, balance, totalDeposit, 0, 0);
  }
